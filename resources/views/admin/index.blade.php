            ...
            <div class="card-body">
                ...
                <div class="latest-massage">
                    ...
                    <a href="#" class="latest-message-list">
                        <div class="border-bottom mt-3 position-relative">
                            <div class="float-left user mr-3">
                                <img src="{{ asset('zinzer/assets/images/users/avatar-3.jpg') }}" alt="" class="rounded-circle mb-3">
                            </div>
                            <div class="message-time">
                    ...
                    <a href="#" class="latest-message-list">
                        <div class="mt-3 position-relative">
                            <div class="float-left user mr-3">
                                <img src="{{ asset('zinzer/assets/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle mb-3">
                            </div>
                            <div class="message-time">
